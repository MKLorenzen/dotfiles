...
before packages are loaded."
  ...
  ;; make emacs always follow symbolic links (no more asking)
  (setq vc-follow-symlinks t)
  ;; (setq initial-major-mode 'org-mode) this is set in config.el
)
